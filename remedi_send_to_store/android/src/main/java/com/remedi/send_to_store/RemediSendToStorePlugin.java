package com.remedi.send_to_store;
 ...
 * StoreRedirectPlugin
 */
public class RemediSendToStorePlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
  ...
  private void onAttachedToEngine(BinaryMessenger messenger) {
    methodChannel = new MethodChannel(messenger, "send_to_store");
